...
var buildOpts = require('./buildOpts');
var checkError = require('./checkError');
var checkArg = require('./checkArg');
var rateLimitHandler = require('./rateLimitHandler');
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 4:
              body = _a.sent();
              if (!checkError(res.status)) return [3, 6];
              if (res.status !== 429) {
            ...
            case 14:
              body = _a.sent();
              if (!checkError(res.status)) return [3, 16];
              if (res.status !== 429) {
                throw new Error(JSON.stringify(body));
              }
      ...
      return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 2:
              data = _a.sent();
              if (!checkError(res.status)) return [3, 4];
              if (res.status !== 429) {
